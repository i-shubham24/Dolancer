          ...
          {FEATURES.map((feat, i) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-2xl border border-line-card bg-surface p-6 shadow-soft-xs hover:border-primary/30 hover:shadow-soft-sm transition-all duration-200 flex flex-col justify-start"
              >
                <div
