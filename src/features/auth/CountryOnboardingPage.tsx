...
export function CountryOnboardingPage() {
  ...
  return (
    <motion.div initial={rise} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, ease: [0.16, 1, 0.3, 1] }} className="relative w-full max-w-2xl py-4 sm:py-8">
      <div className="pointer-events-none absolute -left-16 top-0 h-32 w-32 rounded-full bg-primary-light blur-3xl" aria-hidden="true" />
      ...
      <div className="relative mb-7">
        <p className="mb-3 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.16em] text-primary"><Sparkles className="h-4 w-4" aria-hidden="true" /> One quick step</p>
