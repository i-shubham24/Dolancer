...
export function SearchTrigger() {
  return (
    <button
      ...
      className="inline-flex min-h-[44px] items-center gap-2.5 rounded-full border border-line-card bg-surface px-3.5 py-2 text-sm font-bold text-ink-2 shadow-soft-sm transition-all duration-[120ms] hover:-translate-y-0.5 hover:text-ink hover:shadow-soft-md"
    >
